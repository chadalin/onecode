              ...
              <x-card>
                    ...
                    <a href="{{route('task.store')}}">{{__('Регистрация')}}</a>
                      ...
                      <x-card-body>
                          ...
                          <x-form action="{{route('task.store')}}" method="POST" enctype="multipart/form-data">
                              ...
                              <x-form-item>
                               ...
                               <x-form-item>
                                  ...
                                  <x-label reguired >{{ __('telefon')}}</x-label>
                                  
                                  <input type="text" name="telefon" value="telefon" class="form-control">
                              ...
                              <x-form-item>
                               ...
                               <x-form-item>
                                  ...
                                  <input type="file" name="img" class="form-control" accept="image/phg, image/jpg">
                                   </div>
                              </x-form-item>
